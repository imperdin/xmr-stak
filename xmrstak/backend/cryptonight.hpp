...
template<>
inline constexpr size_t cn_select_memory<cryptonight_saber>() { return CRYPTONIGHT_HEAVY_MEMORY; }

template<>
inline constexpr size_t cn_select_memory<cryptonight_italo>() { return CRYPTONIGHT_HEAVY_MEMORY; }
...
template<>
inline constexpr uint32_t cn_select_mask<cryptonight_saber>() { return CRYPTONIGHT_HEAVY_MASK; }

template<>
inline constexpr uint32_t cn_select_mask<cryptonight_italo>() { return CRYPTONIGHT_HEAVY_MASK; }
...
template<>
inline constexpr uint32_t cn_select_iter<cryptonight_saber>() { return CRYPTONIGHT_HEAVY_ITER; }

template<>
inline constexpr uint32_t cn_select_iter<cryptonight_italo>() { return CRYPTONIGHT_HEAVY_ITER; }
